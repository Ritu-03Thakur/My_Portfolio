  ...
  return (
    <Card className="view view-first" sx={{ margin: 5  , padding : 1}} style = {{
      ...
      <div className="mask" style={{display : "flex" ,  gap : "10px" , flexDirection : "column" }}>
        ...
        <a href= {props.git} style = {{textDecoration : "none  "}}>        
          <Button className="info" size="medium" variant="contained"  style={{backgroundColor : "#113f3a" , textDecoration : "none"}}  >Github</Button>
         </a>
